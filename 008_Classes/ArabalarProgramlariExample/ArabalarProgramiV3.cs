...
{
    class ArabalarProgramiV3
    {
        // Problem: ArabalarProgramiV2'deki içeriği buraya kopyalamak zorundayız. Araba bilgilerini tek bir yerde tutup bu bilgilere tek bir yerden erişemiyoruz.
        // Örneğin Id'sine göre tek bir araba getirmek zor ve yanlış sonuç alabiliriz.
        // Şöyle ki eğer arabalar array'inde Id dışında herhangi bir değer "Id: sayi" şeklinde girildiyse yanlış veriye ulaşabiliriz.

        #region Fields
        string[] arabalar; // arabalar girişi ve gösterimi için
        string programBasligi = "*** Araba Programı V3 ***";
        string marka;
        string model;
        byte kapiSayisi;
        short beygirGucu;
        ...
        string TurGosterimi()
        {
            return "Türü: " + arabaTuru.ToString();
        }
